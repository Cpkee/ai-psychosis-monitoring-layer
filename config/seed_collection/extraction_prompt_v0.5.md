<!--
  Seed extraction prompt, version extraction_prompt_v0.5
...
a longer word**: {prohibited_terms}. For example, write "stopped taking prescribed
medication", not "stopped taking antipsychotic medication", because
"antipsychotic" contains "psychotic"; and write "weeks of little sleep and racing
speech", not a clinical label for it. Only `raw_theme_terms` may quote the

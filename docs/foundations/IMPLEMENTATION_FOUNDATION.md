...
| S0–S7 | **Seed pipeline** — S0 ✅, S1 ✅, S2 ✅, S3 ✅, S4 next | Collect → Filter → Choose → Generate → Review → Label, on a shared PostgreSQL. Full plan: [`SEED_PIPELINE_PLAN.md`](SEED_PIPELINE_PLAN.md). Outside the tracer bullet (§7); supplies the corpus for the pilot and for increment 8. | — |
